...
## 🚀 Overview
Version `v0.2.0-rc1` is centered on shell-first execution control. This release strengthens the safest current path for high-risk shell tools while adding better verification, audit, and host-capability reporting around that execution boundary.
